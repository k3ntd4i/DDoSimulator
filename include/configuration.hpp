...
void initialize_win_background(sf::Texture &win_background_texture, sf::Sprite &win_background_sprite);
void initialize_fail_background(sf::Texture &fail_background_texture, sf::Sprite &fail_background_sprite);
